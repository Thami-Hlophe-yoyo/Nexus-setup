...
NX.direct.api.REMOTING_API = {
  ...
  actions: {
    ...
    coreui_Role: [
      ...
      {
        name: 'update'/*(org.sonatype.nexus.api.extdirect.common.security.role.model.RoleXO) => org.sonatype.nexus.api.extdirect.common.security.role.model.RoleXO */,
        len: 1,
        formHandler: false
      },
      {
        name: 'create'/*(org.sonatype.nexus.api.extdirect.common.security.role.model.RoleXO) => org.sonatype.nexus.api.extdirect.common.security.role.model.RoleXO */,
        len: 1,
        formHandler: false
      },
      {
    ...
    migration_Assistant: [
      ...
      {
        name: 'configure'/*(com.sonatype.nexus.api.extdirect.selfhosted.migration.model.ConfigurationXO) => com.sonatype.nexus.api.extdirect.selfhosted.migration.model.PreviewXO */,
        len: 1,
        formHandler: false
      },
      {
      ...
      {
        name: 'status'/*() => com.sonatype.nexus.api.extdirect.selfhosted.migration.AssistantComponent$StatusXO */,
        len: 0,
        formHandler: false
      }
    ],
    ...
    clm_CLM: [
      {
        name: 'verifyConnection'/*(com.sonatype.nexus.api.extdirect.selfhosted.clm.model.IqConnectionXo) => java.util.List */,
        len: 1,
        formHandler: false
      },
      {
        name: 'read'/*() => com.sonatype.nexus.api.extdirect.selfhosted.clm.model.IqConnectionXo */,
        len: 0,
        formHandler: false
      },
      {
        name: 'update'/*(com.sonatype.nexus.api.extdirect.selfhosted.clm.model.IqConnectionXo) => com.sonatype.nexus.api.extdirect.selfhosted.clm.model.IqConnectionXo */,
        len: 1,
        formHandler: false
      },
      {
    ...
    usertoken_UserToken: [
      {
        name: 'read'/*() => com.sonatype.nexus.usertoken.plugin.rest.model.SettingsXO */,
        len: 0,
        formHandler: false
      },
      {
        name: 'update'/*(com.sonatype.nexus.usertoken.plugin.rest.model.SettingsXO) => com.sonatype.nexus.usertoken.plugin.rest.model.SettingsXO */,
        len: 1,
        formHandler: false
      },
      {
        name: 'reset'/*(String, String, String) => void */,
        len: 3,
        formHandler: false
      },
      {
        name: 'resetAll'/*(String) => void */,
        len: 1,
        formHandler: false
      },
      {
        name: 'status'/*(String, String, String) => com.sonatype.nexus.usertoken.plugin.rest.model.UserTokenStatusXO */,
        len: 3,
        formHandler: false
      }
    ],
